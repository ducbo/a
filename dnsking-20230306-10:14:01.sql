...
INSERT INTO cyberman VALUES(1,10,69,69,0);
CREATE TABLE user (
	id integer primary key,
	email text not null,
...
INSERT INTO user VALUES(114,'gegdom@yahoo.com','PCZybmaQ39SnCe6Lc7nKWgO7Uv3ffDS','ZrtroSupFMMnaIB3',0,'K1bsPJxPAjUdBcCJ',NULL,NULL,NULL,0,0,NULL);
INSERT INTO user VALUES(115,'nfijiaj@yahoo.com','lBI4QXKM64ty2vu9GkId.Jej6eTaAXm','6EwRbFtdAxleeMfg',0,'g527QSX27IChvXG3',NULL,NULL,NULL,0,0,NULL);
INSERT INTO user VALUES(116,'HermesRusaw687@aol.com','r/CVPqkuaNthm6uMwiBy5Bvv2/3FkUa','bDNwUflBwEc0UGdd',0,'Lmb8PSVqu2rbRvhs',NULL,NULL,NULL,0,0,NULL);
...
INSERT INTO session VALUES(89,1,1678103729,'QouckpBnfAPCVmIQTn5N6FZF0JSefBp6');
CREATE TABLE domain (
	id integer primary key,
...
INSERT INTO domain VALUES(33,'esc',1,1,1678083271);
CREATE TABLE record (
	id integer primary key,
...
INSERT INTO record VALUES(40,1,33,'A','@','103.90.224.246');
COMMIT;
